...
class AdapterModelos(var lista: ArrayList<Vehiculo>, var contexto: Context) : BaseAdapter() {
    ...
    override fun getItem(posicion: Int): Vehiculo? {
    ...
    override fun getView(
        ...
        val view: View = LayoutInflater.from(contexto).inflate(R.layout.item_spinner, parent, false)
        ...
        val textoModelo: TextView = view.findViewById(R.id.itemModelo)
