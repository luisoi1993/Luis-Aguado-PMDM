            ...
            binding.botonLogin.id -> {
                ...
                if(binding.editPass.text.isNotEmpty() && binding.editCorreo.text.isNotEmpty()){
                    if(binding.editPass.text.toString().equals(contrasenia) && binding.editCorreo.text.toString().equals(correo)){
                        ...
                        val usuario= Usuario(binding.editCorreo.text.toString(),binding.editPass.text.toString(),binding.spinnerPerfil.selectedItem.toString())
                       ...
                       // intent.putExtra("correo",binding.editCorreo.text.toString())
                        ...
                        Snackbar.make(binding.root, resources.getString(R.string.text_login), Snackbar.LENGTH_SHORT).show()
                    }
